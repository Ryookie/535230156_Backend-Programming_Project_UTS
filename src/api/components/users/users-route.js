...
module.exports = (app) => {
  ...
  route.post(
    '/mbank',
    authenticationMiddleware,
    celebrate(usersValidator.createMbanks),
    usersControllers.createMbanks
  );
  route.get('/mbank/:id', authenticationMiddleware, usersControllers.getMbank
  );
  route.put(
    '/mbank/:id',
    authenticationMiddleware,
    celebrate(usersValidator.updateMbank),
    usersControllers.updateMbank
  );
  route.delete('/delete/:id', authenticationMiddleware, usersControllers.deleteMbank
  );
};
